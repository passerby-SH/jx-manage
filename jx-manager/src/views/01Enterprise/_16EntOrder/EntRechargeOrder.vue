  ...
  <div>
    <el-form :inline="true" :model="queryModel" label-position="right" class="toolbar demo-form-inline">
      <el-row type="flex">
        ...
        <el-form-item :span="6" label="订单号">
          <el-input size="small" v-model="queryModel.mobile" placeholder="请输入订单号"></el-input>
        </el-form-item>
      ...
      <el-row>
        <el-form-item label="提交时间" :span=8>
          <el-date-picker
    ...
    >
      ...
      <el-table-column prop="enterpriseId" align="center" label="订单号" fixed>
        <template slot-scope="scope">
          <span class="globalPointer" size="small"
                @click.stop="toRechargeDetail(scope.$index,scope.row)">{{scope.row.keyId}}</span>
        </template>
      ...
      <el-table-column prop="enterpriseId" align="center" label="充值金额(元)">
        <template slot-scope="scope">
          <span size="small" v-text="scope.row.rechargeBalance"></span>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="enterpriseId" align="center" label="服务费(元)">
        <template slot-scope="scope">
          <span size="small" v-text="scope.row.fee"></span>
        </template>
      </el-table-column>
      ...
      <el-table-column prop="enterpriseId" align="center" label="订单总金额(元)">
        <template slot-scope="scope">
          <span size="small" v-text="scope.row.lastBalance"></span>
        </template>
      </el-table-column>
