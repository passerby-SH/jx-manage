    ...
    <el-form ref="entInfo" :model="detail" v-if="detail" :rules="rules" class="toobar"
      ...
      <el-row type="flex">
        <el-form-item label="订单总金额(元):">
          <span>{{detail.lastBalance}}</span>
        </el-form-item>

        <el-form-item label="充值金额(元):">
          <span>{{detail.rechargeBalance}}</span>
        </el-form-item>
      </el-row>
      ...
      <span class="item-title">审批信息</span>
      <el-row type="flex">
        <el-form-item label="审批人:">
          <span>{{detail.verifyPerson}}</span>
        </el-form-item>
        <el-form-item label="嘉福JOC充值订单号:">
          <span>{{detail.jocOrder}}</span>
        </el-form-item>
      </el-row>
      ...
      <el-row type="flex">
        ...
        <el-form-item label="扣款凭证:" v-show="detail.voucher">
          <img ref="voucher" style="width: 50px; height: 50px" :src="detail.voucher" @click="showBigImg">
