<template>
  <div>
    ...
    <el-dialog title="编辑用户" center width="40%" :visible.sync="editUserModel.visible" :close-on-click-modal="1===0">
      <edit-user-info  :model="editUserModel.model"
                       :userId="editUserModel.model.userId"
                       :mobile="editUserModel.model.mobile"
                       :userName="editUserModel.model.userName"
                       :idNumber="editUserModel.model.idNumber"
                       :isVerify="editUserModel.model.isVerify"
