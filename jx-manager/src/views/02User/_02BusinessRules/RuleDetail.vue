    ...
    <el-form :model="submitModel" :inline="true" ref="ruleForm" :rules="rules">
      ...
      <el-row>
        <el-form-item label="业务类型" required>
          <el-select size="small" v-model="submitModel.businessType" filterable placeholder="请选择业务类型">
            <el-option
      ...
      <el-row>
        <el-form-item label="是否启用" required>
          <el-select size="small" v-model="submitModel.ruleState" filterable  placeholder="请选择启用状态">
            <el-option
    ...
    methods: {
      ...
      _setModel() {
        setTimeout(() => {
          ...
          if (this.isAdd) {
            this.submitModel = {}
            this.submitModel.businessType = '1'
            this.submitModel.ruleState = '0'
          } else {
