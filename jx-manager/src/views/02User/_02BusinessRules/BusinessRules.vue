<template>
    <div>
        ...
        <el-row type="flex" justify="left">
          <el-col :span="3">
            <el-button size="small" type="primary" icon="el-icon-search"
                       ...
                       @click="resetDoQuery">查询</el-button>
          </el-col>
          <el-col :span="3">
      ...
      <el-dialog :title="ruleDetail.title" center width="40%" :visible.sync="ruleDetail.visible" :close-on-click-modal="1===0">
  ...
  export default {
    ...
    methods: {
      ...
      changeRule(row) {
        ...
        Api.updateBusinessRule({keyId: row.keyId, ruleState: row.ruleState}).then(response => {
          this.$notify({
